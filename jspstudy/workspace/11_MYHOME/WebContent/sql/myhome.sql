...
(
	...
	/* 게시글/댓글 */ DEPTH			NUMBER,  /* 게시글: 0, 댓글: 1 이상(원글의 DEPTH + 1) */
...
ALTER TABLE COMMENTS ADD CONSTRAINT COMMENTS_BOARD_FK
	FOREIGN KEY(BNO) REFERENCES BOARD(BNO)
		ON DELETE CASCADE;
ALTER TABLE BOARD ADD CONSTRAINT BOARD_MEMBER_FK
    FOREIGN KEY(WRITER) REFERENCES MEMBER(ID)
        ON DELETE CASCADE;
ALTER TABLE COMMENTS ADD CONSTRAINT COMMENTS_MEMBER_FK
    FOREIGN KEY(WRITER) REFERENCES MEMBER(ID)
        ON DELETE CASCADE;